...
class LotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post lots_url, params: { lot: { address_id: @lot.address_id, google_maps_link: @lot.google_maps_link, image_link: @lot.image_link, note: @lot.note, tad_id: @lot.tad_id } }
    end
  ...
  test "should update lot" do
    patch lot_url(@lot), params: { lot: { address_id: @lot.address_id, google_maps_link: @lot.google_maps_link, image_link: @lot.image_link, note: @lot.note, tad_id: @lot.tad_id } }
